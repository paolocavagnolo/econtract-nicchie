...
// DRIVER (TUTTI E 2 UGUALI) DM320T
// 01 02 03 04 05 06 
// ON ON ON ON ON ON 
...
#define TOP_SPEED  2000
#define TOP_ACC    500

#define MAN_SPEED 1000
#define MAN_ACC 5000

#define ZERO_OFFSET 250

#define CORSA_BASE 15000
#define CORSA_TOP 14000
...
void goToHome() {
  ...
  BASE->move(ZERO_OFFSET);
  TOP->move(ZERO_OFFSET);
